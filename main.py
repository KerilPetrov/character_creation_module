...
def attack(char_name: str, char_class: str) -> str:
    """Фунцкия, определяющая количество урона, нанесенного противнику"""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция, определяющая количество заблокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция, описывающая какое умение применил игрок."""
    if char_class == 'warrior':
